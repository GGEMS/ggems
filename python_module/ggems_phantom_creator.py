...
class GGEMSPhantomCreatorManager(object):
    ...
    def set_element_sizes(self, width, height, depth, unit):
        ggems_lib.set_element_sizes_phantom_creator_manager(self.obj, width, height, depth, unit.encode('ASCII'))

    def set_output(self, output):
        ggems_lib.set_output_image_filename_phantom_creator_manager(self.obj, output.encode('ASCII'))

    def set_range_output(self, output):
        ggems_lib.set_output_range_to_material_filename_phantom_creator_manager(self.obj, output.encode('ASCII'))
    ...
    def set_material(self, material):
        ggems_lib.set_material_phantom_creator_manager(self.obj, material.encode('ASCII'))

    def set_data_type(self, data_type):
        ggems_lib.set_data_type_phantom_creator_manager(self.obj, data_type.encode('ASCII'))
