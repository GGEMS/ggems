...
class GGEMSPhantom(object):
    ...
    def __init__(self):
        ggems_lib.create_ggems_phantom.restype = ctypes.c_void_p
         ...
         ggems_lib.set_phantom_name_ggems_phantom.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
         ggems_lib.set_phantom_name_ggems_phantom.restype = ctypes.c_void_p

         ggems_lib.set_phantom_type_ggems_phantom.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
         ggems_lib.set_phantom_type_ggems_phantom.restype = ctypes.c_void_p

        self.obj = ggems_lib.create_ggems_phantom()

     def set_phantom_name(self, name):
         ggems_lib.set_phantom_name_ggems_phantom(self.obj, name.encode('ASCII'))

     def set_phantom_type(self, name):
         ggems_lib.set_phantom_type_ggems_phantom(self.obj, name.encode('ASCII'))
