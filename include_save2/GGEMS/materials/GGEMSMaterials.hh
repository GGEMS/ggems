...
class GGEMS_EXPORT GGEMSMaterials
{
  public:
    ...
    */
    ...
    /*!
      \fn inline cl::Buffer* GetMaterialTables(GGsize const& index) const
    ...
    */
    inline cl::Buffer* GetMaterialTables(GGsize const& index) const {return material_tables_[index];}
