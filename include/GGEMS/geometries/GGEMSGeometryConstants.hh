...
constant GGfloat EPSILON2 = 1.0e-02f; /*!< Epsilon of 0.01 */
constant GGfloat EPSILON3 = 1.0e-03f; /*!< Epsilon of 0.001 */
constant GGfloat EPSILON6 = 1.0e-06f; /*!< Epsilon of 0.000001 */
constant GGfloat GEOMETRY_TOLERANCE = 1.0e-04f; /*!< Geometry tolerance, 100 nm */
