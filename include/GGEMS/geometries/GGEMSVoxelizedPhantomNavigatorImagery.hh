...
/*!
  ...
  \brief GGEMS class managing voxelized phantom navigator for imagery application
*/
class GGEMS_EXPORT GGEMSVoxelizedPhantomNavigatorImagery
  : public GGEMSPhantomNavigator
{
  public:
    /*!
...
*/
extern "C" GGEMS_EXPORT GGEMSVoxelizedPhantomNavigatorImagery*
...
/*!
  \fn void set_phantom_file_ggems_voxelized_phantom_navigator_imagery(GGEMSVoxelizedPhantomNavigatorImagery* p_voxelized_phantom_navigator_imagery, char const* phantom_navigator_name)
  \param p_voxelized_phantom_navigator_imagery - pointer on the navigator
...
/*!
  \fn void set_range_to_material_filename_ggems_voxelized_phantom_navigator_imagery(GGEMSVoxelizedPhantomNavigatorImagery* p_voxelized_phantom_navigator_imagery, char const* phantom_navigator_name)
  \param p_voxelized_phantom_navigator_imagery - pointer on the navigator
