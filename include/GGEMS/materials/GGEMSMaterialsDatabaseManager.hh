...
class GGEMS_EXPORT GGEMSMaterialsDatabaseManager
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn inline GGfloat GetAtomicNumberDensity(std::string const& material, GGsize const& index) const
      \param material - name of the material
    ...
    */
    inline GGfloat GetAtomicNumberDensity(std::string const& material, GGsize const& index) const
    {
