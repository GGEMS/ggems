...
__host__ __device__ f32 GetLambda ( f32 Range, const ElectronsCrossSectionTable &d_table, ui8 mat );
...
__host__ __device__ f32 eLoss (f32 LossLength, f32 Ekine, f32 dedxeIoni, f32 dedxeBrem, f32 erange,
                               ...
                               const MaterialsTable &materials, ParticlesData &particles, ui32 id );
...
__host__ __device__ f32 GlobalMscScattering (f32 GeomPath, f32 cutstep, f32 CurrentRange, f32 CurrentEnergy, f32 CurrentLambda, f32 dedxeIoni,
                                             f32 dedxeBrem, const ElectronsCrossSectionTable &d_table, ui8 mat, ParticlesData &particles, ui32 id,
                                             f32 par1, f32 par2, const MaterialsTable &materials, DoseData &dosi, ui32xyzw index_phantom,
...
__host__ __device__ void eMscScattering (f32 tPath, f32 zPath, f32 currentRange, f32 currentLambda, f32 currentEnergy, f32 par1, f32 par2,
                                         ParticlesData &particles, ui32 id, const MaterialsTable &materials, ui8 mat,
