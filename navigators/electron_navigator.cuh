...
__host__ __device__ f32 GetLambda( f32 Range, const ElectronsCrossSectionData *d_table, ui8 mat );
...
__host__ __device__ f32 eLoss( f32 LossLength, f32 Ekine, f32 dedxeIoni, f32 dedxeBrem, f32 erange,
                               ...
                               const MaterialsData *materials, ParticlesData *particles, ui32 id );
...
__host__ __device__ f32 GlobalMscScattering( f32 GeomPath, f32 cutstep, f32 CurrentRange, f32 CurrentEnergy, f32 CurrentLambda, f32 dedxeIoni,
                                             f32 dedxeBrem, const ElectronsCrossSectionData *d_table, ui8 mat, ParticlesData *particles, ui32 id,
                                             f32 par1, f32 par2, const MaterialsData *materials, DoseData *dosi,
                                             const VoxVolumeData<ui16> *phantom, const GlobalSimulationParametersData *parameters );
