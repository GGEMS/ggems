...
cl_manager = ggems.GGEMSOpenCLManager()
cl_manager.set_context_index(2)  # Activate a context
cl_manager.print_infos()  # Printing informations about OpenCL
