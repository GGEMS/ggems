...
/*!
  \fn __kernel void particle_solid_distance_ggems_solid_box(GGlong const particle_id_limit, global GGEMSPrimaryParticles* primary_particle, global GGEMSVoxelizedSolidData* voxelized_solid_data)
