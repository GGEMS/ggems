...
/*!
  \fn __kernel void distance_to_voxelized_solid(__global GGEMSPrimaryParticles* primary_particle, __global GGEMSVoxelizedSolidData* voxelized_solid_data)
...
*/
__kernel void distance_to_voxelized_solid(
