...
/*!
  \fn kernel void get_primaries_ggems_voxelized_source(GGsize const particle_id_limit, global GGEMSPrimaryParticles* primary_particle, global GGEMSRandom* random, GGchar const particle_name, global GGfloat const* energy_spectrum, global GGfloat const* cdf, GGint const number_of_energy_bins, global GGfloat44 const* matrix_transformation)
