...
phantom.set_phantom('data/Thorax.mhd', 'data/HU2mat.txt')
phantom.set_rotation(0.0, 0.0, 0.0, 'deg')
phantom.set_position(0.0, 0.0, 0.0, 'mm')

ct_detector = GGEMSCTSystem('Pixium_3030')
ct_detector.set_ct_type('flat')
ct_detector.set_number_of_modules(1, 1)
ct_detector.set_number_of_detection_elements(1956, 1956, 1)
ct_detector.set_size_of_detection_elements(0.154, 0.154, 0.6, 'mm')
...
point_source.set_rotation(0.0, 0.0, 90.0, 'deg')
point_source.set_beam_aperture(11.5, 'deg')
