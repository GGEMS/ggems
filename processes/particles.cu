...
{
    particles.size = h_params->size_of_particles_batch;
    particles.data_h.size = h_params->size_of_particles_batch;
...
void ParticleManager::m_cpu_malloc_stack()
{
    ...
    particles.data_h.sec_E =     ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_dx =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_dy =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_dz =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_px =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_py =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_pz =    ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_tof =   ( f32* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( f32 ) );
    particles.data_h.sec_pname = ( ui8* ) malloc ( particles.size * mh_params->nb_of_secondaries * sizeof ( ui8 ) );
...
{    
    ...
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_E,     particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_dx,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_dy,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_dz,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_px,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_py,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_pz,    particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_tof,   particles.size * mh_params->nb_of_secondaries *sizeof ( f32 ) ) );
    HANDLE_ERROR ( cudaMalloc ( ( void** ) &particles.data_d.sec_pname, particles.size * mh_params->nb_of_secondaries *sizeof ( ui8 ) ) );
