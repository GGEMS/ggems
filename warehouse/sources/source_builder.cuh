...
// Point source
#define ADR_POINT_SRC_PX 3
#define ADR_POINT_SRC_PY 4
#define ADR_POINT_SRC_PZ 5
#define ADR_POINT_SRC_ENERGY 6
#define ADR_POINT_SRC_PARTPDEC 7

// Cylinder source
#define ADR_CYLINDER_SRC_PX 3
#define ADR_CYLINDER_SRC_PY 4
#define ADR_CYLINDER_SRC_PZ 5
#define ADR_CYLINDER_SRC_RAD 6
#define ADR_CYLINDER_SRC_LEN 7
#define ADR_CYLINDER_SRC_ENERGY 8
#define ADR_CYLINDER_SRC_PARTPDEC 9

// Planar source
#define ADR_PLANAR_SRC_PX 3
#define ADR_PLANAR_SRC_PY 4
#define ADR_PLANAR_SRC_PZ 5
#define ADR_PLANAR_SRC_WID 6
#define ADR_PLANAR_SRC_LEN 7
#define ADR_PLANAR_SRC_ENERGY 8
#define ADR_PLANAR_SRC_PARTPDEC 9

// Cone Beam source
#define ADR_CONE_BEAM_SRC_PX 3
#define ADR_CONE_BEAM_SRC_PY 4
#define ADR_CONE_BEAM_SRC_PZ 5
#define ADR_CONE_BEAM_SRC_PHI 6
#define ADR_CONE_BEAM_SRC_THETA 7
#define ADR_CONE_BEAM_SRC_PSI 8
#define ADR_CONE_BEAM_SRC_APERTURE 9
#define ADR_CONE_BEAM_SRC_ENERGY 10

// Voxelized source
#define ADR_VOX_SOURCE_PX 3
#define ADR_VOX_SOURCE_PY 4
#define ADR_VOX_SOURCE_PZ 5
#define ADR_VOX_SOURCE_NB_VOX_X 6
#define ADR_VOX_SOURCE_NB_VOX_Y 7
#define ADR_VOX_SOURCE_NB_VOX_Z 8
#define ADR_VOX_SOURCE_SPACING_X 9
#define ADR_VOX_SOURCE_SPACING_Y 10
#define ADR_VOX_SOURCE_SPACING_Z 11
//#define ADR_VOX_SOURCE_ENERGY 12
#define ADR_VOX_SOURCE_EMISSION_TYPE 12
#define ADR_VOX_SOURCE_TOT_ACTIVITY 13
#define ADR_VOX_SOURCE_NB_CDF 14
#define ADR_VOX_SOURCE_CDF_INDEX 15
#define ADR_VOX_SOURCE_ENERGY 16
#define ADR_VOX_SOURCE_PARTPDEC 17

#define SIZE_POINT_SRC 8
#define SIZE_CYLINDER_SRC 10
#define SIZE_PLANAR_SRC 10
#define SIZE_VOX_SRC 18
